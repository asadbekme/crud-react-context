  ...
  return (
    ...
    >
      <div className="flex-auto text-left px-4 py-2 m-2">
        <p className="text-gray-900 text-2xl font-semibold leading-none">
          Name: {employee.name}
        </p>
        <p className="text-gray-600 text-xl font-normal mt-2 mb-1">
          Job: {employee.job}
        </p>
        <span className="inline-block text-[19px] font-semibold">
          Company: {employee.company}
        </span>
      </div>
      <div className="flex-auto text-right px-4 py-2 m-2">
        <Link to={`/edit-employee/${employee.id}`} title="Edit Employee">
